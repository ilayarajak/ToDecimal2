...
from .to_decimal_dialog import ToDecimalDialog
import os.path
from math import pi
...
class ToDecimal:
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ToDecimal', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/to_decimal/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'to_decimal'),
            callback=self.run,
